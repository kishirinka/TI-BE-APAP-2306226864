...
const handleSubmit = async (formData: InsurancePlanRequest) => {
  ...
  try {
    const result = await insurancePlanStore.updateInsurancePlan(planId, formData);
    
    if (result.success) {
      // Redirect to detail view after 1 second
      setTimeout(() => {
    ...
    <main class="max-w-4xl mx-auto pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      ...
      <div v-if="isLoading" class="bg-white rounded-lg shadow-sm border border-gray-200 p-12">
        <div class="flex flex-col items-center justify-center gap-4">
          ...
          <p class="text-gray-600">Loading insurance plan data...</p>
        </div>
      </div>
      ...
      <div v-else-if="insurancePlanStore.currentPlan">
        ...
        <div class="mb-8">
          ...
          <h1 class="text-3xl font-bold text-gray-900">Edit Insurance Plan</h1>
          <p class="text-gray-600 mt-2">Update the information for this insurance plan</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 relative">
          ...
          <VInsurancePlanForm
            mode="edit"
            :insurancePlan="insurancePlanStore.currentPlan"
            @submit="handleSubmit"
          />
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul class="space-y-2 text-sm text-blue-800">
            <li class="flex items-start gap-2">
              ...
              <span>
                <strong>Provider ID</strong> cannot be changed after creation (field is read-only)
              </span>
            </li>
            <li class="flex items-start gap-2">
              <svg class="w-4 h-4 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li class="flex items-start gap-2">
              ...
              <span>Changes will be reflected immediately after successful update</span>
            </li>
          </ul>
        </div>
      </div>
